...
#swww img --transition-type grow --transition-pos 0.054,0.977 --transition-fps 58 ~/Pictures/Wallpapers/hyprchan.png &&

wal -q -n -i ~/Pictures/Wallpapers/layla_crystal.jpg
hyprpanel
